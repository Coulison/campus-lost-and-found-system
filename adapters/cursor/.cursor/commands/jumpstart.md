...
Run the COMPLETE Jumpstart pipeline for the product idea I give you, single-agent (Cursor has no subagents). Usage: `/jumpstart <idea> [hours] [team_size] [skill_level]`.
